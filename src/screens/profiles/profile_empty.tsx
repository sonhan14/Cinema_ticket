...
export const SaveCards = ({navigation} : any) => {
    return <View style={{ height: layout.height * 0.2, width: layout.width, flexDirection: 'column' }}>
        ...
        <TouchableOpacity style={styles.buttonSaveCardStyle} onPress={() => { navigation.navigate('Profile') }}>
        ...
        <View style={styles.paymentsBoxStyle}>
            <FontAwesomeIcon name='briefcase' color={color.text_session} size={90} />
            <Text style={[styles.text_place, { color: color.text_session }]}>You haven't bought tickets yet</Text>
        </View>
